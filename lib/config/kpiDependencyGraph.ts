...
const DEPENDENCIES: Record<string, Pick<KpiDependencyNode, "required" | "optional" | "reportKpis">> = {
  ...
  current_census: { required: ["admissions", "discharges"], optional: ["patient_days", "daily_census_trend"], reportKpis: ["current_census_by_service_line_branch", "daily_census_trend"] },
  census: { required: ["admissions", "discharges"], optional: ["patient_days", "daily_census_trend"], reportKpis: ["current_census_by_service_line_branch", "daily_census_trend"] },
  average_daily_census: { required: ["patient_days"], optional: ["admissions", "discharges", "daily_census_trend"], reportKpis: ["current_census_by_service_line_branch", "patient_days", "daily_census_trend"] },
  ...
  daily_census_trend: { required: ["daily_census"], optional: ["admissions", "discharges", "average_daily_census"], reportKpis: ["daily_census_trend", "current_census_by_service_line_branch"] },
  visit_notes_activity: { required: [], optional: ["current_census", "admissions"], reportKpis: ["visit_notes"] },
