...
const SOURCES: SourceDefinition[] = [
  ...
  { file: "Current Census By Service Line and Branch.sql", kpi: "current_census_by_service_line_branch", resultNames: ["Operational (episode based) Current Census By Service Line and Branch — Current Census"] },
  { file: "14 Rolling Days ADC with Patient Days and Current Census vs ADC.sql", kpi: "average_daily_census", resultNames: ["Operational (episode based) Current Census By Service Line and Branch + 14 Rolling Days ADC with Patient Days and Current Census vs ADC — 14-Day ADC and Patient Days"] },
